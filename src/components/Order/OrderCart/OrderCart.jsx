                ...
                <div className={cl.fields}>
                    ...
                    <div className={cl.footer}>
                        ...
                        <div className={cl.code}>
                            {errors?.cvv && <p className={cl.error}>{errors?.cvv?.message || "Error"}</p>}
                            <label htmlFor="">
                                <span>Code:</span>
                                <input maxLength={3} placeholder={'cvv'} type="text" {...register('cvv', {
